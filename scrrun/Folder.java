...
/** @com.class(classid=C7C3F5B3-88A3-11D0-ABCB-00A0C90FFFC0,DynamicCasts) 
    @com.interface(iid=C7C3F5A2-88A3-11D0-ABCB-00A0C90FFFC0, thread=AUTO, type=DUAL) */
public class Folder implements IUnknown,com.ms.com.NoAutoScripting,scrrun.IFolder
{
  ...
  /** @com.method(vtoffset=16, dispid=1010, type=PROPGET, name="Type", name2="getType", addFlagsVtable=4)
      @com.parameters([type=STRING] return) */
  public native String getType();

  /** @com.method(vtoffset=17, dispid=1201, type=METHOD, name="Delete", addFlagsVtable=4)
      @com.parameters([in,type=BOOLEAN] Force) */
  public native void Delete(boolean Force);

  /** @com.method(vtoffset=18, dispid=1203, type=METHOD, name="Copy", addFlagsVtable=4)
  ...
  /** @com.method(vtoffset=19, dispid=1205, type=METHOD, name="Move", addFlagsVtable=4)
      @com.parameters([in,type=STRING] Destination) */
  public native void Move(String Destination);

  /** @com.method(vtoffset=20, dispid=10000, type=PROPGET, name="IsRootFolder", name2="getIsRootFolder", addFlagsVtable=4)
      @com.parameters([type=BOOLEAN] return) */
  public native boolean getIsRootFolder();

  /** @com.method(vtoffset=21, dispid=1009, type=PROPGET, name="Size", name2="getSize", addFlagsVtable=4)
      @com.parameters([type=VARIANT] return) */
  public native Variant getSize();

  /** @com.method(vtoffset=22, dispid=10001, type=PROPGET, name="SubFolders", name2="getSubFolders", addFlagsVtable=4)
      @com.parameters([iid=C7C3F5A3-88A3-11D0-ABCB-00A0C90FFFC0,thread=AUTO,type=DISPATCH] return) */
  public native scrrun.IFolderCollection getSubFolders();

  /** @com.method(vtoffset=23, dispid=10002, type=PROPGET, name="Files", name2="getFiles", addFlagsVtable=4)
      @com.parameters([iid=C7C3F5A5-88A3-11D0-ABCB-00A0C90FFFC0,thread=AUTO,type=DISPATCH] return) */
  public native scrrun.IFileCollection getFiles();

  /** @com.method(vtoffset=24, dispid=1101, type=METHOD, name="CreateTextFile", addFlagsVtable=4)
  ...
  public static final com.ms.com._Guid iid = new com.ms.com._Guid((int)0xc7c3f5a2, (short)0x88a3, (short)0x11d0, (byte)0xab, (byte)0xcb, (byte)0x0, (byte)0xa0, (byte)0xc9, (byte)0xf, (byte)0xff, (byte)0xc0);

  public static final com.ms.com._Guid clsid = new com.ms.com._Guid((int)0xc7c3f5b3, (short)0x88a3, (short)0x11d0, (byte)0xab, (byte)0xcb, (byte)0x0, (byte)0xa0, (byte)0xc9, (byte)0xf, (byte)0xff, (byte)0xc0);
}
