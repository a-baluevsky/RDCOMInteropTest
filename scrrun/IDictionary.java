...
public interface IDictionary extends IUnknown
{
  ...
  public void setItem(Variant Key, Variant pRetItem);
  ...
  public void Add(Variant Key, Variant Item);
  ...
  public boolean Exists(Variant Key);
  ...
  public void setKey(Variant Key, Variant _jcomparam_1);
  ...
  public void Remove(Variant Key);
  ...
  public void setCompareMode(int pcomp);
  ...
  /** @com.method(vtoffset=18, dispid=10, type=PROPGET, name="HashVal", name2="getHashVal", addFlagsVtable=4)
      @com.parameters([in,elementType=VARIANT,type=PTR] Key, [type=VARIANT] return)
      @hidden */
  public Variant getHashVal(Variant Key);
