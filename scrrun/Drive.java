...
/** @com.class(classid=C7C3F5B1-88A3-11D0-ABCB-00A0C90FFFC0,DynamicCasts) 
    @com.interface(iid=C7C3F5A0-88A3-11D0-ABCB-00A0C90FFFC0, thread=AUTO, type=DUAL) */
public class Drive implements IUnknown,com.ms.com.NoAutoScripting,scrrun.IDrive
{
  ...
  /** @com.method(vtoffset=5, dispid=10000, type=PROPGET, name="DriveLetter", name2="getDriveLetter", addFlagsVtable=4)
      @com.parameters([type=STRING] return) */
  public native String getDriveLetter();
  ...
  public native int getDriveType();
  ...
  public native scrrun.IFolder getRootFolder();
  ...
  public static final com.ms.com._Guid clsid = new com.ms.com._Guid((int)0xc7c3f5b1, (short)0x88a3, (short)0x11d0, (byte)0xab, (byte)0xcb, (byte)0x0, (byte)0xa0, (byte)0xc9, (byte)0xf, (byte)0xff, (byte)0xc0);
}
