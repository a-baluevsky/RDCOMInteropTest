...
/** @com.class(classid=0D43FE01-F093-11CF-8940-00A0C9054228,DynamicCasts) 
    @com.interface(iid=2A0B9D10-4B87-11D3-A97A-00104B365C9F, thread=AUTO, type=DUAL) */
public class FileSystemObject implements IUnknown,com.ms.com.NoAutoScripting,scrrun.IFileSystem3
{
  ...
  public native scrrun.IDriveCollection getDrives();
  ...
  public native String BuildPath(String Path, String Name);
  ...
  public native boolean DriveExists(String DriveSpec);
  ...
  public native boolean FileExists(String FileSpec);
  ...
  public native boolean FolderExists(String FolderSpec);
  ...
  public native scrrun.IDrive GetDrive(String DriveSpec);
  ...
  public native scrrun.IFile GetFile(String FilePath);
  ...
  public native scrrun.IFolder GetFolder(String FolderPath);
  ...
  public native scrrun.IFolder GetSpecialFolder(int SpecialFolder);
  ...
  public native void DeleteFile(String FileSpec, boolean Force);
  ...
  public native void DeleteFolder(String FolderSpec, boolean Force);
  ...
  public native void MoveFile(String Source, String Destination);

  /** @com.method(vtoffset=23, dispid=1205, type=METHOD, name="MoveFolder", addFlagsVtable=4)
      @com.parameters([in,type=STRING] Source, [in,type=STRING] Destination) */
  public native void MoveFolder(String Source, String Destination);
  ...
  public native void CopyFile(String Source, String Destination, boolean OverWriteFiles);

  /** @com.method(vtoffset=25, dispid=1203, type=METHOD, name="CopyFolder", addFlagsVtable=4)
      @com.parameters([in,type=STRING] Source, [in,type=STRING] Destination, [in,type=BOOLEAN] OverWriteFiles) */
  public native void CopyFolder(String Source, String Destination, boolean OverWriteFiles);
  ...
  public native scrrun.IFolder CreateFolder(String Path);
  ...
  public native scrrun.ITextStream CreateTextFile(String FileName, boolean Overwrite, boolean Unicode);
  ...
  public native scrrun.ITextStream OpenTextFile(String FileName, int IOMode, boolean Create, int Format);
  ...
  public native scrrun.ITextStream GetStandardStream(int StandardStreamType, boolean Unicode);
  ...
  public native String GetFileVersion(String FileName);
  ...
  public static final com.ms.com._Guid clsid = new com.ms.com._Guid((int)0xd43fe01, (short)0xf093, (short)0x11cf, (byte)0x89, (byte)0x40, (byte)0x0, (byte)0xa0, (byte)0xc9, (byte)0x5, (byte)0x42, (byte)0x28);
}
