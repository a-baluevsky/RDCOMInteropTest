...
public interface _RefalModules extends IUnknown
{
  ...
  public refaldriver._RefalModule AddFromScript(String[] ScriptSourceCode, boolean RegisterAssembly);
  ...
  public refaldriver._RefalModule AddFromRslFile(String[] ModuleName, String[] RslFileName, boolean RegisterAssembly);
  ...
  public refaldriver._RefalModule AddFromRefFile(String[] ModuleName, String[] RefFileName, boolean RegisterAssembly);
  ...
  public void Add(refaldriver._RefalModule[] RefalModule, boolean[] RegisterAssembly);
