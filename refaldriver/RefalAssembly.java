...
/** @com.class(classid=B01059D3-9950-4267-BF40-051CBF294B2F,DynamicCasts) 
    @com.interface(iid=A4E7EE28-0B57-4E63-A058-7A91997E8530, thread=AUTO, type=DUAL) */
public class RefalAssembly implements IUnknown,com.ms.com.NoAutoScripting,refaldriver._RefalAssembly
{
  ...
  public native void AddModule(refaldriver._RefalModule[] RefalModule);
  ...
  public native int getModulesCount();
  ...
  public native void RemoveModule(Variant ModuleNameIndex);
  ...
  public native String GetModuleListString(Variant ModuleList);
  ...
  public native int Run(String[] CommandLine, String[] InputData, String[] OutputData);
  ...
  public native String Serialize(String[] TargetRasmFileName);
  ...
  public native void FileSerialize(String[] RasmFileName);

  /** @com.method(vtoffset=14, dispid=1610809355, type=METHOD, name="FileDeserialize", addFlagsVtable=4)
      @com.parameters([in,out,size=1,elementType=STRING,type=ARRAY] RasmFileName) */
  public native void FileDeserialize(String[] RasmFileName);
  ...
  public static final com.ms.com._Guid clsid = new com.ms.com._Guid((int)0xb01059d3, (short)0x9950, (short)0x4267, (byte)0xbf, (byte)0x40, (byte)0x5, (byte)0x1c, (byte)0xbf, (byte)0x29, (byte)0x4b, (byte)0x2f);
}
