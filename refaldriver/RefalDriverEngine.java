...
/** @com.class(classid=40F7791A-95A1-44AC-8DAE-A429B75DA214,DynamicCasts) 
    @com.interface(iid=2079A6CF-82D5-4924-A08F-D1454ABE92CA, thread=AUTO, type=DUAL) */
public class RefalDriverEngine implements IUnknown,com.ms.com.NoAutoScripting,refaldriver._RefalDriverEngine
{
  ...
  public native refaldriver._RefalAssemblies getAssemblies();
  ...
  public native refaldriver._RefalModules getModules();
  ...
  public native refaldriver._RefalDriverOptions getDriverOptions();
  ...
  public native refaldriver._Utility getUtility();
  ...
  public native refaldriver._RefalModule Compile(String[] RefalModuleName, String[] RefFileName);
  ...
  public native int Run(String[] AssemblyName, String[] CommandLine, String[] InputData, String[] OutputData);
  ...
  public native int ExecuteRefalCode(Variant AutoTemplateOptions, String[] RefalCode, String[] InputData, String[] OutputData);
  ...
  public static final com.ms.com._Guid clsid = new com.ms.com._Guid((int)0x40f7791a, (short)0x95a1, (short)0x44ac, (byte)0x8d, (byte)0xae, (byte)0xa4, (byte)0x29, (byte)0xb7, (byte)0x5d, (byte)0xa2, (byte)0x14);
}
